...
TOP_LEVEL_NAME="PLL_GenClocks"
QSYS_SIMDIR="./../../"
QUARTUS_INSTALL_DIR="/media/hdd1t/quartus/17.0_lite/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_GenClocks.vo"
fi
