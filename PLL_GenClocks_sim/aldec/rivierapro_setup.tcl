...
# ACDS 17.0 595 linux 2019.04.02.12:32:55
# ----------------------------------------
...
# ----------------------------------------
# If PLL_GenClocks is one of several IP cores in your
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "PLL_GenClocks"
}
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "/media/hdd1t/quartus/17.0_lite/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vlog -v2k5 $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL_GenClocks.vo"
}
